package com.example.cloud.cloudconfig.controller;
...
public class RefreshController {
    ...
    public ResponseEntity refresh(@RequestBody String str){
        ...
        new Thread(() ->{
            ...
            ResponseEntity<String> responseEntity = restTemplate.postForEntity("http://cloud-config/actuator/bus-refresh", request, String.class);
        }).start();
